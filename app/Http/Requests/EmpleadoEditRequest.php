...
class EmpleadoEditRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|min:2|max:120|unique:empleado,email,' . $this->empleado->id,
            'phone' => 'required|integer|gte:600000000|lte:999999999|unique:empleado,phone,' . $this->empleado->id,
